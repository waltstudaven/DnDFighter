 ...
 *   images/Pig.gif
 */
public class FighterSubClassComboBox extends JPanel
        implements ActionListener {
    JLabel pictureLeft;
    JLabel pictureRight;

    public FighterSubClassComboBox(JPanel Creater) {
...
//        rightPictureHolder.setPreferredSize(new Dimension(367,550));
    ...
    protected void updateLabel(String name) {
        ...
        if (isMacOs)
        {
            iconLeft = createImageIcon(dir + "/data/" + name + "Male.png");
            iconRight = createImageIcon(dir + "/data/" + name + "Female.png");
        } else {
            iconLeft = createImageIcon(dir + "\\DnDFighter\\data\\" + name + "Male.png");
            iconRight = createImageIcon(dir + "\\DnDFighter\\data\\" + name + "Female.png");
        }
